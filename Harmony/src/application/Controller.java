...
{
	@FXML
	private Group chatDisplay;

	@FXML
	private Group startDisplay;
	...
	@FXML
	private ImageView startRoomIcon;

	@FXML
	private Line selectedRoomLine;

	@FXML
	private TextFlow mainTextFlow;

	@FXML
	private ScrollPane mainTxtScrollPane;

	@FXML
	private TextArea enterMsgTextArea;

	@FXML
	private Group loginScreen;
	...
	@FXML
	private Text badConnection;

	@FXML
	private Text accountInUse;
	...
	public void clickStartRoom()
	{
		...
		try
		{
			...
			{
				case 1:
					Main.saveRoomOne(mainTextFlow.getChildren());
					break;

				case 2:
					Main.saveRoomTwo(mainTextFlow.getChildren());
					break;

				case 3:
					Main.saveRoomThree(mainTextFlow.getChildren());
					break;
	...
	@FXML
	private TextFlow peopleTextFlow;
	...
	private void displayMsg(String msg)
	{
		...
		if(parsedMsg[3].compareTo(roomNum + "") != 0) // TODO Change so that all messages are displayed in their respective ArrayLists stored in main
			return;
	...
	private boolean checkAccountDetails() // TODO Lock out users (no multi logins)
	{
	...
	@FXML
	private Rectangle closeHitBox;

	@FXML
	private Rectangle minimizeHitBox;

	@FXML
	private Rectangle closeBG;

	@FXML
	private Rectangle minimizeBG;

	@FXML
	private Line closeIcon1;

	@FXML
	private Line closeIcon2;
