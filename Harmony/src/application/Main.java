...
public class Main extends Application
{
	...
	@Override
	public void start(Stage primaryStage) // Laptop 2601:602:c880:2820:0:0:0:d9c5
	{
		try
		{
...
//			controller = loader.getController();
	...
	public static void saveRoomOne(ObservableList<Node> room)
	{
		roomOneChat = new ArrayList<Node>();
		room.forEach((element) -> roomOneChat.add(element));
	}
	
	public static void saveRoomTwo(ObservableList<Node> room)
	{
		roomTwoChat = new ArrayList<Node>();
		room.forEach((element) -> roomTwoChat.add(element));
	}
	
	public static void saveRoomThree(ObservableList<Node> room)
	{
		roomThreeChat = new ArrayList<Node>();
		room.forEach((element) -> roomThreeChat.add(element));
	}
